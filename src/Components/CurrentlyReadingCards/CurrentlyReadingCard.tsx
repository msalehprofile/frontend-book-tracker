  ...
  return (
    <div className="currentlyReadingCard">
      ...
      <div className="currentlyReadingCard__details">
        <p className="currentlyReadingCard__details--title">{title}</p>
        <p className="currentlyReadingCard__details--book">{author}</p>
        <p className="currentlyReadingCard__details--book">
          Pages: {numberOfPages}
        </p>
        <Link to="/myBooks/reviewbook">
          <button
            className="currentlyReadingCard__details--button"
